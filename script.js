  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        errorMessage = getFieldLabel(form, field) + ' is required.';
        ...
        errorMessage = getFieldLabel(form, field) + ' must be at least ' + field.minLength + ' characters.';
      } else if (field.maxLength && field.maxLength > 0 && value.length > field.maxLength) {
        errorMessage = getFieldLabel(form, field) + ' must not exceed ' + field.maxLength + ' characters.';
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אנה ואבן הקסמים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'c77aff93-1e72-4549-a750-655cfa4d9294',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'c77aff93-1e72-4549-a750-655cfa4d9294';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 0554423535 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c77aff93-1e72-4549-a750-655cfa4d9294';
